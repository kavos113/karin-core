...
void GraphicsContext::drawEllipse(Point center, float radiusX, float radiusY, Pattern *pattern, const StrokeStyle& strokeStyle) const
{
    m_impl->drawEllipse(center, radiusX, radiusY, pattern, strokeStyle);
}

void GraphicsContext::drawRoundedRect(Rectangle rect, float radiusX, float radiusY, Pattern *pattern, const StrokeStyle& strokeStyle) const
{
