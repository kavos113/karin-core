...
void GraphicsContext::fillEllipse(
    Point center, float radiusX, float radiusY, Pattern& pattern, Transform2D transform
) const
{
...
void GraphicsContext::fillRoundedRect(
    Rectangle rect, float radiusX, float radiusY, Pattern& pattern, Transform2D transform
) const
{
...
void GraphicsContext::drawLine(
    Point start, Point end, Pattern& pattern, const StrokeStyle& strokeStyle, Transform2D transform
) const
{
...
void GraphicsContext::drawRect(
    Rectangle rect, Pattern& pattern, const StrokeStyle& strokeStyle, Transform2D transform
) const
{
...
void GraphicsContext::drawEllipse(
    Point center, float radiusX, float radiusY, Pattern& pattern, const StrokeStyle& strokeStyle, Transform2D transform
) const
{
...
void GraphicsContext::fillPath(const Path& path, Pattern& pattern, Transform2D transform) const
{
    m_impl->fillPath(*path.impl(), pattern, transform);
}

void GraphicsContext::drawPath(
    const Path& path, Pattern& pattern, const StrokeStyle& strokeStyle, Transform2D transform
) const
{
...
void GraphicsContext::drawImage(
    Image image, Rectangle destRect, Rectangle srcRect, float opacity, Transform2D transform
) const
{
    m_impl->drawImage(image, destRect, srcRect, opacity, transform);
}

void GraphicsContext::drawText(const TextLayout& text, Point start, Pattern& pattern, Transform2D transform) const
{
